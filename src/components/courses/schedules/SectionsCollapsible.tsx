...
import { ScheduleLegend, getClassTypeColor, getClassTypeShort } from '@/components/courses/schedules/ScheduleLegend'
...
export default function SectionsCollapsible({
	...
	const { data: courses, loading: isPending } = useNDJSONStream<any>('https://public.osuc.dev/courses-sections.ndjson')
