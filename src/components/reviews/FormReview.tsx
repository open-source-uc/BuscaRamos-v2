          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="rating-0" className="cursor-pointer">
                  No lo recomiendo
                </Label>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-6">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="difficulty-0" className="cursor-pointer">
                  Baja
                </Label>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-6">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="assistance-0" className="cursor-pointer">
                  Obligatoria
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="assistance-1" className="cursor-pointer">
                  Opcional
                </Label>
              </div>
            </div>
