  ...
  return (
    <Collapsible open={filtersOpen} onOpenChange={onFiltersOpenChange}>
      <div className="bg-accent rounded-md">
        <CollapsibleTrigger
          className={`${filtersOpen ? "rounded-t-md" : "rounded-md"} flex w-full items-center border border-border justify-between px-4 py-2 transition-colors`}
        >
        ...
        <CollapsibleContent className="border-border border rounded-b-md">
          <div className="space-y-6 p-6">
            ...
            <div className="tablet:grid-cols-2 desktop:grid-cols-3 grid grid-cols-1 gap-4">
              ...
              {/* School Filter */}
              <div className="space-y-2">
                <label className="text-foreground text-sm font-medium">Unidad Académica</label>
                <Combobox
            ...
            <div className="tablet:grid-cols-2 grid grid-cols-1 gap-4">
              {/* English Filter */}
              <div className="space-y-2">
                <label className="text-foreground text-sm font-medium">Solo Cursos en Inglés</label>
